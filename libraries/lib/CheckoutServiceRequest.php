...
class CheckoutServiceRequest
{
    ...
    protected $test_uri = 'https://api-test.klarna.com/touchpoint/checkout/';
    ...
    {
        return ($this->config['mode'] == Klarna::LIVE ? $this->uri.'?'.http_build_query($this->params) : $this->test_uri.'?'.http_build_query($this->params));
    }
